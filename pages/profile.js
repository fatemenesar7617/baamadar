...
export default function ProfilePage() {
  ...
  const handleLogout = () => {
    // برای زمانی که بعداً اطلاعات کاربر را ذخیره کردی
    ...
    <main className="max-w-[390px] mx-auto min-h-screen bg-white flex flex-col pb-20">
      ...
      <div className="px-4 pb-6">
        <button
          ...
          className="w-full h-12 border border-gray-200 text-gray-500 rounded-2xl font-peyda font-semibold text-sm hover:bg-gray-50 transition-colors"
        >
          خروج از حساب کاربری
        </button>
      </div>
